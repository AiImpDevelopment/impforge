...
<h3 align="center">One app. Every tool. Zero cloud dependency.</h3>

<p align="center">
  <strong>The AI workstation that replaces 15 subscriptions<br/>and keeps your data on your machine.</strong>
</p>
...
**Does ImpForge work without internet?**
Yes. Core features, local AI, and all your data work 100% offline. Cloud AI (OpenRouter) is optional and opt-in.

**Can I import my existing data?**
Yes. ImpForge imports from VS Code, Obsidian, Notion, JetBrains, Google Calendar, Outlook, and 20+ other tools.

**Is my data encrypted?**
Yes. ForgeVault uses AES-256-GCM encryption with Argon2id key derivation — the same standards used by security-focused password managers.
